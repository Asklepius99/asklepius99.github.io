...
const apps = [
    {
        id: 1,
        name: "First Sight",
        description: "Gerçek hayatta tanışmanın en doğal hali. Konum tabanlı tanışma uygulaması.",
    ...
    {
        id: 2,
        name: "Örnek Uygulama 2",
        description: "Modern arayüzü ile kullanıcı dostu bir deneyim sunar.",
        icon: "🎨",
    ...
    {
        id: 3,
        name: "Örnek Uygulama 3",
        description: "Hızlı ve güvenilir çözümler sunan profesyonel bir uygulama.",
        icon: "⚡",
        tags: ["Hız", "Güvenlik"],
        page: "app3.html"
    }
...
function loadApps() {
    ...
    appsGrid.innerHTML = apps.map(app => `
        <a href="${app.page}" class="app-card">
            <div class="app-icon">
                ${app.icon.endsWith('.svg') || app.icon.endsWith('.png') || app.icon.endsWith('.jpg') 
